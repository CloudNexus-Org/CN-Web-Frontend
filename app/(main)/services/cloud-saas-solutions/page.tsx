      ...
      <div className="mx-auto max-w-4xl px-4 pt-24 pb-24 lg:px-8">
        ...
        >
          ...
          <p className="mt-6 text-lg text-black/60 dark:text-white/60 leading-relaxed">
            Cloud migration, cloud-native apps, and scalable SaaS platform development. We help businesses move to the cloud and build products that serve millions.
          </p>
        </motion.div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-black/55 dark:text-white/55 leading-relaxed">
              <li className="flex items-start gap-3">
                ...
                Cloud migration from on-premise to AWS, Azure, or GCP
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-blue-500 shrink-0" />
