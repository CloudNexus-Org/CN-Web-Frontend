    ...
    <section className="min-h-screen">
      <div className="w-full pt-24 pb-16 px-6">
        <div className="mx-auto max-w-7xl">
          ...
          <h1 className="text-4xl sm:text-5xl font-semibold tracking-tight mb-4">mCommerce</h1>
          <p className="text-lg text-muted-foreground max-w-2xl">Mobile commerce platforms with AR try-on, one-tap checkout, and QR-based payments.</p>
        </div>
      </div>
      ...
      <div className="w-full px-6 py-16 border-b border-border">
        <div className="mx-auto max-w-7xl">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h2 className="text-2xl font-semibold mb-4">Mobile Commerce Revolution</h2>
              <p className="text-[15px] text-muted-foreground leading-relaxed">We build mobile-first commerce apps and QR-based payment solutions that make buying and selling seamless on smartphones. Our mCommerce platforms feature AR try-on experiences, one-tap checkout, and universal QR payment systems serving millions of users and merchants.</p>
            </div>
            <div>
              <p className="text-[15px] text-muted-foreground leading-relaxed mb-6">From camera-integrated AR product visualization and biometric-authenticated express payments to merchant self-onboarding in under 5 minutes and offline transaction support for rural areas, we help businesses capture the mobile commerce opportunity.</p>
              <div className="grid grid-cols-3 gap-4">
                <div className="p-4 rounded-xl border border-border bg-card">
                  <p className="text-2xl font-bold text-foreground">2M+</p>
                  <p className="text-[12px] text-muted-foreground mt-1">Active users</p>
                </div>
                <div className="p-4 rounded-xl border border-border bg-card">
                  <p className="text-2xl font-bold text-foreground">100K+</p>
                  <p className="text-[12px] text-muted-foreground mt-1">Merchants</p>
                </div>
                <div className="p-4 rounded-xl border border-border bg-card">
                  <p className="text-2xl font-bold text-foreground">55%</p>
                  <p className="text-[12px] text-muted-foreground mt-1">Less abandonment</p>
                </div>
              </div>
            </div>
          </div>
