    ...
    <section className="min-h-screen">
      <div className="w-full pt-24 pb-16 px-6">
        <div className="mx-auto max-w-7xl">
          ...
          <h1 className="text-4xl sm:text-5xl font-semibold tracking-tight mb-4">Social Networking</h1>
          <p className="text-lg text-muted-foreground max-w-2xl">
            Community and social platforms with real-time messaging and content management.
          </p>
        </div>
      </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="p-4 rounded-xl border border-border bg-card">
                  ...
                  <p className="text-[12px] text-muted-foreground mt-1">Users supported</p>
                </div>
                <div className="p-4 rounded-xl border border-border bg-card">
                  <p className="text-2xl font-bold text-foreground">15ms</p>
                  <p className="text-[12px] text-muted-foreground mt-1">Message latency</p>
                </div>
                <div className="p-4 rounded-xl border border-border bg-card">
                  <p className="text-2xl font-bold text-foreground">4</p>
                  <p className="text-[12px] text-muted-foreground mt-1">Platforms built</p>
                </div>
              </div>
            </div>
          </div>
