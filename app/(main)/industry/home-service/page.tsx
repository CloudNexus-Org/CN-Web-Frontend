    ...
    <section className="min-h-screen">
      <div className="w-full pt-24 pb-16 px-6">
        <div className="mx-auto max-w-7xl">
          ...
          <h1 className="text-4xl sm:text-5xl font-semibold tracking-tight mb-4">Home Service</h1>
          <p className="text-lg text-muted-foreground max-w-2xl">On-demand home service platforms connecting professionals with homeowners.</p>
        </div>
      </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="p-4 rounded-xl border border-border bg-card">
                  ...
                  <p className="text-[12px] text-muted-foreground mt-1">Professionals</p>
                </div>
                <div className="p-4 rounded-xl border border-border bg-card">
                  <p className="text-2xl font-bold text-foreground">5000+</p>
                  <p className="text-[12px] text-muted-foreground mt-1">Monthly bookings</p>
                </div>
                <div className="p-4 rounded-xl border border-border bg-card">
