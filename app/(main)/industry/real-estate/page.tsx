    ...
    <section className="min-h-screen">
      <div className="w-full pt-24 pb-16 px-6">
        <div className="mx-auto max-w-7xl">
          ...
          <h1 className="text-4xl sm:text-5xl font-semibold tracking-tight mb-4">Real Estate</h1>
          <p className="text-lg text-muted-foreground max-w-2xl">
            Property tech platforms with AI valuations, virtual tours, and automated management.
          </p>
        </div>
      </div>
      ...
      <div className="w-full px-6 py-16 border-b border-border">
        <div className="mx-auto max-w-7xl">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h2 className="text-2xl font-semibold mb-4">Digitizing Real Estate</h2>
              <p className="text-[15px] text-muted-foreground leading-relaxed">
                We build property technology platforms that automate valuations, enable virtual tours, and streamline
                property management. Our AI-powered solutions help real estate companies list, manage, and transact
                properties faster and more efficiently.
              </p>
            </div>
            <div>
              <p className="text-[15px] text-muted-foreground leading-relaxed mb-6">
                Our PropTech solutions include AI-based property valuation engines, 360° virtual tour integrations,
                automated tenant screening, digital lease signing, and centralized maintenance management systems. We
                help property managers go fully digital with zero paperwork.
              </p>
              <div className="grid grid-cols-3 gap-4">
                <div className="p-4 rounded-xl border border-border bg-card">
                  <p className="text-2xl font-bold text-foreground">25K+</p>
                  <p className="text-[12px] text-muted-foreground mt-1">Listings managed</p>
                </div>
                <div className="p-4 rounded-xl border border-border bg-card">
                  <p className="text-2xl font-bold text-foreground">15K+</p>
                  <p className="text-[12px] text-muted-foreground mt-1">Units automated</p>
                </div>
                <div className="p-4 rounded-xl border border-border bg-card">
                  <p className="text-2xl font-bold text-foreground">45%</p>
                  <p className="text-[12px] text-muted-foreground mt-1">Faster valuations</p>
                </div>
              </div>
            </div>
          </div>
