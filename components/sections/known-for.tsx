...
const CustomSoftwareVisual = () => (
  <div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-1000 overflow-hidden">
    <div className="absolute right-[-10%] bottom-[-20%] w-64 h-64 rotate-[30deg] skew-x-[20deg] scale-90 group-hover:scale-100 transition-transform duration-1000">
      <div className="absolute inset-0 border border-[#215B97]/20 bg-gradient-to-tr from-[#215B97]/5 to-transparent rounded-xl translate-y-8 group-hover:translate-y-0 transition-transform duration-1000 delay-100" />
...
const UIUXVisual = () => (
  <div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-1000 overflow-hidden">
    <div className="absolute right-0 bottom-0 w-48 h-48 blur-2xl opacity-40 mix-blend-screen translate-y-4 group-hover:translate-y-0 transition-transform duration-1000">
      <div className="absolute top-4 left-4 w-24 h-24 bg-[#215B97] rounded-full mix-blend-multiply animate-[pulse_4s_ease-in-out_infinite]" />
...
const AIMLVisual = () => (
  <div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-1000 overflow-hidden">
    <div className="absolute -right-8 -bottom-8 w-64 h-64 flex items-center justify-center">
      <div className="absolute w-2 h-2 bg-[#215B97] rounded-full shadow-[0_0_20px_4px_#215B97] z-10" />
      {[1, 2, 3, 4].map((i) => (
        <div key={i} className="absolute border border-[#215B97]/30 rounded-full animate-[ping_4s_cubic-bezier(0,0,0.2,1)_infinite]" style={{ width: `${i * 3}rem`, height: `${i * 3}rem`, animationDelay: `${i * 1}s` }} />
      ))}
...
const MobileVisual = () => (
  <div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-1000 overflow-hidden">
    <div className="absolute right-4 bottom-[-10%] w-24 h-48 border border-white/5 rounded-3xl overflow-hidden group-hover:-translate-y-4 transition-transform duration-1000 ease-out">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#215B97]/0 via-[#215B97]/40 to-[#215B97]/0 opacity-50 -translate-y-[100%] group-hover:animate-[shimmer_3s_infinite]" />
      {/* Screen glow */}
      <div className="absolute inset-2 bg-gradient-to-br from-[#215B97]/10 to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-1000 delay-300" />
      {/* Screen elements */}
  ...
  <div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-1000 overflow-hidden">
    <div className="absolute right-4 bottom-4 w-40 h-28 perspective-1000">
      <div className="relative w-full h-full transform-style-3d rotate-x-12 rotate-y-[-10deg]">
        <div className="absolute inset-0 bg-[#111] border border-white/10 rounded-xl translate-z-0 group-hover:translate-x-2 group-hover:-translate-y-2 group-hover:border-[#215B97]/30 transition-all duration-700 shadow-2xl" />
        <div className="absolute inset-0 bg-[#1a1a1a]/80 backdrop-blur-sm border border-white/5 rounded-xl -translate-z-4 group-hover:-translate-x-2 group-hover:translate-y-2 transition-all duration-700 delay-100 shadow-2xl flex flex-col p-3 gap-2">
          <div className="w-1/3 h-1.5 bg-[#215B97]/40 rounded-full" />
...
const CloudVisual = () => (
  <div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-1000 overflow-hidden">
    <svg className="absolute right-[-10%] bottom-[-10%] w-64 h-64 text-[#215B97]/20" viewBox="0 0 100 100">
      ...
      <circle cx="20" cy="80" r="1.5" fill="#215B97" className="opacity-50 group-hover:opacity-100 group-hover:shadow-[0_0_8px_#215B97] transition-all duration-1000" />
      <circle cx="80" cy="20" r="1.5" fill="#215B97" className="opacity-50 group-hover:opacity-100 group-hover:shadow-[0_0_8px_#215B97] transition-all duration-1000 delay-100" />
  ...
  <div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-1000 overflow-hidden flex items-end justify-end p-6">
    <div className="grid grid-cols-4 gap-2 w-24 h-24">
      {[...Array(16)].map((_, i) => (
        <div 
          key={i} 
          className="bg-white/5 border border-white/10 w-full h-full rounded-[2px] group-hover:rounded-full group-hover:bg-[#215B97]/20 group-hover:border-[#215B97]/40 transition-all duration-1000 ease-in-out" 
...
const DigitalMarketingVisual = () => (
  <div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-1000 overflow-hidden">
    <svg className="absolute w-[200%] h-32 bottom-[-10%] right-[-20%] text-[#215B97]/10 group-hover:text-[#215B97]/30 transition-colors duration-1000" viewBox="0 0 200 50" preserveAspectRatio="none">
...
const CyberVisual = () => (
  <div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-1000 overflow-hidden">
    <div className="absolute -right-8 -bottom-8 w-64 h-64 flex items-center justify-center opacity-40 group-hover:opacity-100 transition-opacity duration-1000">
      <div className="absolute w-32 h-32 border-t-2 border-r-2 border-transparent border-t-[#215B97]/50 rounded-full animate-[spin_4s_linear_infinite]" />
...
const DevOpsVisual = () => (
  <div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-1000 overflow-hidden">
    <svg className="absolute right-4 bottom-4 w-48 h-24 text-white/5" viewBox="0 0 100 50">
      ...
      <path d="M 25 25 C 10 10, 10 40, 25 25 C 40 10, 60 40, 75 25 C 90 10, 90 40, 75 25 C 60 10, 40 40, 25 25" fill="none" stroke="#215B97" strokeWidth="2" strokeLinecap="round" className="custom-infinity opacity-0 group-hover:opacity-100 transition-opacity duration-1000 group-hover:animate-[infinity_4s_linear_infinite]" style={{ filter: 'drop-shadow(0 0 4px #215B97)' }} />
    </svg>
  </div>
);
      ...
      <div className="mx-auto max-w-7xl px-6 md:px-8">
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col h-full pointer-events-none w-full">
                    {/* Icon */}
                    <div className="mb-5 flex h-10 w-10 items-center justify-center rounded-lg border border-white/10 bg-[#161616] text-[#ededed] group-hover:text-[#215B97] group-hover:border-[#215B97]/30 group-hover:bg-[#1a1a1a] transition-all duration-500 shadow-sm">
                    ...
                    {/* Description */}
                    <p className="text-[14px] text-[#8b8b8b] group-hover:text-[#a1a1a1] leading-relaxed flex-1 w-[90%] transition-colors duration-300 font-medium">
                      {service.description}
                    </p>

                    {/* CTA */}
                    <div className="mt-5 flex items-center text-[#215B97] text-[13px] font-medium opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-500 ease-[cubic-bezier(0.2,0.8,0.2,1)]">
              ...
              {services.map((_, i) => (
                <button
                  ...
                  style={{
                    ...
                    height: '6px',
                    borderRadius: '9999px',
                    backgroundColor: i === activeIndex ? '#215B97' : '#333',
                  }}
        ...
        <div className="mt-6 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-sm bg-[#215B97]/10 border border-[#215B97]/20 w-fit shadow-[0_0_15px_rgba(59,130,246,0.1)]">
            ...
            <span className="text-[13px] font-medium text-[#215B97] tracking-wide uppercase">Our Services</span>
          </div>
          ...
          <Link
            href="/services"
            className="text-[13px] font-semibold text-[#215B97] hover:underline inline-flex items-center gap-1"
          >
            View All Services
