  ...
  return (
    <section className="relative w-full overflow-hidden bg-white dark:bg-black py-12 sm:py-24 mb-12">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-10 flex flex-col sm:flex-row sm:items-center gap-4 px-4 sm:px-0">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-sm bg-[#215B97]/10 border border-[#215B97]/20 w-fit shadow-[0_0_15px_rgba(59,130,246,0.1)]">
            ...
            <span className="text-[13px] font-medium text-[#215B97] tracking-wide uppercase">Loved by builders</span>
          </div>
